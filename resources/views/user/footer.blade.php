...
<body>
    ...
    <footer class="relative z-10 bg-[#9F8F7B] pb-10 pt-20  lg:pb-20 lg:pt-[120px]">
        <div class="container mx-auto">
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                    <div class="mb-10 w-full">
                        <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
                            <img src="{{asset ('asset/images/logo2.png') }}" alt="logo" class="w-20" />
                            <h1 class="text-white text-3xl font-bold">IKA UNDIP</h1>
                        </a>
                        ...
                        <p class="flex items-center text-sm font-medium ">
                            ...
                            <span class="text-white">0815-11-777-999</span>
                        </p>
                    </div>
                </div>
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                    <div class="mb-10 w-full">
                        ...
                        <div class="mb-6 flex items-center">
                            <a href="javascript:void(0)"
                                class="mr-3 flex h-8 w-8 items-center justify-center rounded-full border text-white border-stroke hover:border-primary hover:bg-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                        ...
                        <p class="text-base text-white">
                            &copy; 2024 Web Portal IKA UNDIP
                        </p>
                    </div>
                </div>
            </div>
